...
GROUP BY main_product_id, related_product_id, dt;
...
FROM (
         ...
         SELECT main_product_id,
             ...
             DATE (behavior_time) AS stat_date FROM `ods_user_behavior`
...
ON t1.main_product_id = t2.main_product_id AND t1.stat_date = t2.stat_date
GROUP BY t1.main_product_id, t1.stat_date, t1.total_main_visit, t1.total_main_cart;


select *
from dws_product_behavior_sequence_stats;

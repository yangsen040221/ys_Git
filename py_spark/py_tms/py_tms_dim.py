...
# create_hdfs_dir("/warehouse/py_tms/dim/dim_complex_full")
# spark.sql("DROP TABLE IF EXISTS  py_tms_dim.dim_complex_full")
# spark.sql("""
# CREATE EXTERNAL TABLE  py_tms_dim.dim_complex_full (
...
# STORED AS ORC
# LOCATION '/warehouse/py_tms/dim/dim_complex_full'
...
#
# # 写入数据
# joined.withColumn("dt", F.lit("20250718")) \
#     .write.mode("overwrite") \
#     .partitionBy("dt") \
#     .orc("/warehouse/py_tms/dim/dim_complex_full")
#
# # 修复分区
...
# create_hdfs_dir("/warehouse/py_tms/dim/dim_organ_full")
# spark.sql("DROP TABLE IF EXISTS  py_tms_dim.dim_organ_full")
# spark.sql("""
# CREATE EXTERNAL TABLE  py_tms_dim.dim_organ_full (
...
# PARTITIONED BY (dt STRING COMMENT '统计日期')
# STORED AS ORC
# LOCATION '/warehouse/py_tms/dim/dim_organ_full'
# TBLPROPERTIES ('orc.compress' = 'snappy');
# """)
#
...
#     .write.mode("overwrite") \
#     .partitionBy("dt") \
#     .orc("/warehouse/py_tms/dim/dim_organ_full")
#
# repair_hive_table("dim_organ_full")

# # ====================== 3. 地区维度表 dim_region_full ======================
# create_hdfs_dir("/warehouse/py_tms/dim/dim_region_full")
# spark.sql("DROP TABLE IF EXISTS  py_tms_dim.dim_region_full")
# spark.sql("""
# CREATE EXTERNAL TABLE  py_tms_dim.dim_region_full (
...
# PARTITIONED BY (dt STRING COMMENT '统计日期')
# STORED AS ORC
# LOCATION '/warehouse/py_tms/dim/dim_region_full'
# TBLPROPERTIES ('orc.compress' = 'snappy');
# """)
#
...
#
# region_df.withColumn("dt", F.lit("20250718")) \
#     .write.mode("overwrite") \
#     .partitionBy("dt") \
#     .orc("/warehouse/py_tms/dim/dim_region_full")
#
# repair_hive_table("dim_region_full")

# # ====================== 4. 快递员维度表 dim_express_courier_full ======================
# create_hdfs_dir("/warehouse/py_tms/dim/dim_express_courier_full")
# spark.sql("DROP TABLE IF EXISTS  py_tms_dim.dim_express_courier_full")
# spark.sql("""
# CREATE EXTERNAL TABLE  py_tms_dim.dim_express_courier_full (
...
# PARTITIONED BY (dt STRING COMMENT '统计日期')
# STORED AS ORC
# LOCATION '/warehouse/py_tms/dim/dim_express_courier_full'
# TBLPROPERTIES ('orc.compress' = 'snappy');
# """)
#
...
#     .write.mode("overwrite") \
#     .partitionBy("dt") \
#     .orc("/warehouse/py_tms/dim/dim_express_courier_full")
#
# repair_hive_table("dim_express_courier_full")

# ====================== 5. 班次维度表 dim_shift_full ======================
create_hdfs_dir("/warehouse/py_tms/dim/dim_shift_full")
spark.sql("DROP TABLE IF EXISTS  py_tms_dim.dim_shift_full")
spark.sql("""
CREATE EXTERNAL TABLE  py_tms_dim.dim_shift_full (
...
STORED AS ORC
LOCATION '/warehouse/py_tms/dim/dim_shift_full'
TBLPROPERTIES ('orc.compress' = 'snappy');
""")
...
spark.sql("DROP TABLE IF EXISTS  py_tms_dim.dim_truck_driver_full")
spark.sql("""
CREATE EXTERNAL TABLE  py_tms_dim.dim_truck_driver_full (
...
PARTITIONED BY (dt STRING COMMENT '统计日期')
STORED AS ORC
LOCATION '/warehouse/py_tms/dim/dim_truck_driver_full'
TBLPROPERTIES ('orc.compress' = 'snappy');
""")
...
joined.withColumn("dt", F.lit("20250718")) \
    .write.mode("overwrite") \
    .partitionBy("dt") \
    .orc("/warehouse/py_tms/dim/dim_truck_driver_full")
...
spark.sql("""
CREATE EXTERNAL TABLE  py_tms_dim.dim_truck_full (
...
PARTITIONED BY (dt STRING COMMENT '统计日期')
STORED AS ORC
LOCATION '/warehouse/py_tms/dim/dim_truck_full'
TBLPROPERTIES ('orc.compress' = 'snappy');
""")
...
spark.sql("DROP TABLE IF EXISTS  py_tms_dim.dim_user_zip")
spark.sql("""
CREATE EXTERNAL TABLE  py_tms_dim.dim_user_zip (
...
PARTITIONED BY (dt STRING COMMENT '统计日期')
STORED AS ORC
LOCATION '/warehouse/py_tms/dim/dim_user_zip'
TBLPROPERTIES ('orc.compress' = 'snappy');
""")
...
user_df.withColumn("dt", F.lit("20250718")) \
    .write.mode("overwrite") \
    .partitionBy("dt") \
    .orc("/warehouse/py_tms/dim/dim_user_zip")
...
spark.sql("""
CREATE EXTERNAL TABLE  py_tms_dim.dim_user_address_zip (
...
PARTITIONED BY (dt STRING COMMENT '统计日期')
STORED AS ORC
LOCATION '/warehouse/py_tms/dim/dim_user_address_zip'
TBLPROPERTIES ('orc.compress' = 'snappy');
""")
...
addr_df.withColumn("dt", F.lit("20250718")) \
    .write.mode("overwrite") \
    .partitionBy("dt") \
